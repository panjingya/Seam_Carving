...
bool reduce_horizontal_seam_trivial(cv::Mat& in_image, cv::Mat& out_image, cv::Mat& Mat_gray);


bool reduce_vertical_seam_trivial(cv::Mat& in_image, cv::Mat& out_image, cv::Mat& Mat_gray);
